...
from app.api.schema.user_attendance import OneStudentEnrollmentOut, StudentAttendanceOut
...
@router.get(
    ...
    response_model=List[StudentAttendanceOut],
)
...
@router.get(
    ...
    response_model=OneStudentEnrollmentOut,
)
